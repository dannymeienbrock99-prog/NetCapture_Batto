...
$setupBaseName = 'CrazyBatto-NetCapture-Setup-v0.6.8'
...
Write-Host 'Erstelle NetCapture v0.6.8 für Program Files ohne temporären Setup-Loader ...' -ForegroundColor Cyan
