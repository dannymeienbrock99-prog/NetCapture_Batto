...
$setupBaseName = 'CrazyBatto-NetCapture-Setup-v0.6.4'
...
Write-Host 'Erstelle NetCapture v0.6.4 für Program Files ohne temporären Setup-Loader ...' -ForegroundColor Cyan
