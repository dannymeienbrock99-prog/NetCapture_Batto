...
$setupBaseName = 'CrazyBatto-NetCapture-Setup-v0.6.9'
...
Write-Host 'Erstelle NetCapture v0.6.9 für Program Files ohne temporären Setup-Loader ...' -ForegroundColor Cyan
