...
$setupBaseName = 'CrazyBatto-NetCapture-Setup-v0.6.7'
...
Write-Host 'Erstelle NetCapture v0.6.7 für Program Files ohne temporären Setup-Loader ...' -ForegroundColor Cyan
